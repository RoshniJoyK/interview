                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Not attended</li>
                        </ol>
                    </nav>
                </div>
                <!-- <div class="ms-auto">
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">Not Attended Candidates</h5>
                            </h5>
                        </div>
                        <div class="card-body p-4">
                            <form class="form_div" id="notAttended">
                            @csrf
                                <div class="row mb-4">
