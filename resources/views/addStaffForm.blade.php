                    ...
                    <div class="col-lg-8 mx-auto">
								...
								<form id="add_staff" enctype="multipart/form-data" >
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control text-capitalize" id="p_company" name="p_company[]" value="{{$pexperience->p_company}}">
										</div>
                                    ...
                                    <div class="row mb-3" id="exp_from_to">
										...
										<div class="col-sm-9 d-flex justify-content-between">
                                            <div class="d-flex m-1">
                                                ...
                                                <input type="month" class="form-control" id="from" name="from[]" value="{{$pexperience->from}}">

                                            <div class="d-flex m-1">
                                                <label for="to" class="col-sm-3 col-form-label">To</label>

                                                <input type="month" class="form-control" id="to" name="to[]" value="{{$pexperience->to}}">
						...
						@endif
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input  class="form-control" id="offerdetails" name="offerdetails" rows="3" placeholder=""></input>
										</div>
									</div>
									<div class="row mb-3">
										<label for="input40" class="col-sm-3 col-form-label">Salary: </label>
										<div class="col-sm-9">
											<input class="form-control" id="salary" name="salary" rows="3" placeholder="">
										</div>
									</div>
									<div class="row mb-3">
									...
									<div class="row mb-3">
										<label for="input5" class="col-sm-3 col-form-label">Upload Offer Letter:</label>
										<div class="col-sm-9">
										<input type="file" class="form-control" id="uploadoffer" name="uploadoffer" placeholder="">
                                    ...
                                    <div class="row mb-3">
										<label for="input11" class="col-sm-3 col-form-label">Training Period: </label>
                                                          <div class="col-sm-9">
                                                            <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="traingperiod" id="traingperiod" checked>
                                    ...
                                    <div id="show-content">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                            <input type="text" class="form-control" id="trainingnumberofdays" name="trainingnumberofdays" placeholder="">
