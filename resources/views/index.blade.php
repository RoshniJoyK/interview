...
<head>
	...
	<title>Galtech - Admin Login</title>
</head>
							...
							<div class="card-body">
								<div class="p-4">
									<div class="mb-3 text-center">
										<img src="../assets/images/galtech-logo.png" width="150" alt="" />
									</div>
									...
									<div class="form-body">
										<form class="row g-3" method="post" name="login_form" id="login_form" action="/login">
											@csrf
											<div class="col-12">
											...
											<div class="clearfix">
												@if(session('success'))
													<p style="color:#a90101;" align="center">{{session('success')}}</p>
												@endif
											</div> 
											<div class="col-12">
												<div class="d-grid">
